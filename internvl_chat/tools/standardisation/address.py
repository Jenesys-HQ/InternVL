...
#         address = addresses[0]
#
#         address_line_1 = address.street_number + ' ' + address.street_name + ' ' + address.street_type
#         address_line_2 = address.occupancy
#         city = address.city
...
#         "City": city,
#         "Postcode": post_code.replace(' ', '').upper() if post_code else None,
#         "Country": country
#     }
